...
export class MyTable extends LitElement {
  ...
  render() {
    ...
    const headers = Object.keys(data[0]).map(header => (header == 'Item Description') ? html`<th style='white-space:nowrap!important; min-width:300px!important'>${header}</th>` : html`<th class="text-nowrap">${header}</th>`);
